...
일어난다.** adversarial을 차단한 K-A만 1000에서 미잠김이고 2000에는 잠긴다 — adversarial은 붕괴를
늦추지만 막지 못하며 붕괴의 필요조건이 아니다. **(2) 즉시·완전한 회복은 "학습 가능한 디코더 × adversarial ON"에서만
